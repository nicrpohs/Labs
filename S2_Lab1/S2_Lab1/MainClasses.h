...
namespace isp
{
	const unsigned char FioWidht = 41;//ширина колонки FIO дл€ консольной печати
	const unsigned char GradeWidht = 7;//ширина колонки FIO дл€ консольной печати
	const unsigned char OtherWidht = 14;//ширина других колонок дл€ консольной печати
	const unsigned char StrNumWidht = 3;//ширина других колонок дл€ консольной печати
	...
	public:
		...
		bool del(GradeRecord&);      // удалить первую подход€щую строку ведомости 
